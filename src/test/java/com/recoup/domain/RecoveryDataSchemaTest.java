...
class RecoveryDataSchemaTest {
    ...
    void acceptsAnAuditableRecoveryCase() {
        PlannedAction retry = new PlannedAction(
                RecoveryActionType.RETRY_PAYMENT, FAILURE_TIME.plusSeconds(3_600), "Retry after the bank outage window", 500);
    ...
    void rejectsInvalidMoneyAndPrematureExecution() {
        ...
        PlannedAction action = new PlannedAction(
                RecoveryActionType.RETRY_PAYMENT, FAILURE_TIME.plusSeconds(60), "One retry is allowed", 500);
